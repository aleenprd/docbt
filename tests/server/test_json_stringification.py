...
class TestDfToJsonCompact:
    ...
    @pytest.mark.skipif(
        True, 
        reason="Requires external network access to download tiktoken encodings"
    )
    ...
    def test_default_behavior_unchanged(self):
        ...
        assert '  ' in default_json or '\t' in default_json, "Default JSON should contain indentation"
...
class TestTokenReductionBenefit:
    ...
    def test_realistic_character_savings(self):
        ...
        df = pd.DataFrame({
            ...
            'purchase_amount': [129.99, 249.50, 89.99, 399.00, 159.99, 
                              299.00, 179.50, 449.99, 99.99, 199.00],
    ...
    def test_realistic_token_savings(self):
        ...
        assert savings_percentage > 5, f"Should achieve at least 5% token savings, got {savings_percentage:.1f}%"
